    ...
    try {
      await fetchEventSource(url, {
        ...
        body: JSON.stringify({
          ...
          ...(this.lastRequest.strategy_ids ? { strategy_ids: this.lastRequest.strategy_ids } : {}),
          ...(this.lastRequest.strategy_params_map ? { strategy_params_map: this.lastRequest.strategy_params_map } : {}),
          ...(this.lastRequest.proxy_address ? { proxy_address: this.lastRequest.proxy_address } : {}),
        }),
